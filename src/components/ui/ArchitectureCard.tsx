    ...
    >
      ...
      <div className="p-5">
        ...
        <div className="mt-4 flex flex-col gap-4">
          <div className="flex items-center justify-between text-blue-600 text-sm font-semibold">
          ...
          <button 
            ...
            className="w-full py-2 bg-slate-900 text-white rounded-lg text-sm font-semibold hover:bg-blue-600 transition-colors shadow-sm"
          >
            Build for me!
          </button>
        </div>
